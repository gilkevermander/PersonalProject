...
public class SneukiePresentation : MonoBehaviour 
{
	...
	private SneukieGestureListener SneukieGestureListener;
	...
	void Start() 
	{
        ...
        SneukieGestureListener = Camera.main.GetComponent<SneukieGestureListener>();
	}
	...
	void Update() 
	{
		...
		if(!isSpinning)
		{
			...
			if(slideChangeWithGestures && SneukieGestureListener)
			{
				if(SneukieGestureListener.IsPush())
                {
                    //RotateToNext();
                    //laad start knop
                    //hak bloem om xxx
                ...
                else if(SneukieGestureListener.IsSwipeRight())
                {
                    RotateToPrevious();
                //hak bloem om xxx
            }
